...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-construction-mgmt-secret-key-change-in-production'
)
...
ALLOWED_HOSTS += [
    "andrewemaddd.pythonanywhere.com",
    "127.0.0.1",
    "localhost",
]
...
# PostgreSQL (use SQLite fallback for dev if PG not available)
DATABASES = {
    'default': {
